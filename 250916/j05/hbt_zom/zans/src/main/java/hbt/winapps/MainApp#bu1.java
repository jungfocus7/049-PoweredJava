...
//                     // String msg = "X: " + mpt.getX() + ", Y: " + mpt.getY();
//                     // // MainApp.println(msg);
...
//                     // double cw = _cellw + 1;
//                     // double ch = _cellh + 1;
//                     // // int dx = Math.floor(mpt.getX() / cw);
//                     // int dx = (int)Math.floor(_grdw / cw);
//                     // if (dx < 0) dx = 0;
//                     // else if (dx > (_colcnt - 1)) dx = (_colcnt - 1);
//                     // int dy = (int)Math.floor(_grdh / ch);
//                     // if (dy < 0) dy = 0;
//                     // else if (dy > (_rowcnt - 1)) dy = (_rowcnt - 1);
//                     // String msg = ">>> dx: " + dx + ", dy: " + dy;
//                     // MainApp.println(msg);
//                 }
//             });
...
//                     // double dx = Math.floor(mpt.getX() / _cellw);
//                     // double dy = Math.floor(mpt.getY() / _cellh);
//                     // String msg = ">>> dx: " + dx + ", dy: " + dy;
//                     // MainApp.println(msg);
...
//             // RenderingHints rhs = new RenderingHints(
//             //     RenderingHints.KEY_ANTIALIASING,
//             //     RenderingHints.VALUE_ANTIALIAS_ON);
//             // g2d.setRenderingHint(null, rhs);
