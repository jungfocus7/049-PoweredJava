...
//         private final int _grdw = (get_crw() * _colcnt) + 1;
//         public int get_grdw() {
//             return _grdw;
//         }
//         private final int _grdh = (get_crh() * _rowcnt) + 1;
//         public int get_grdh() {
//             return _grdh;
//         }
...
//         public _CellRect(_CellCanvas pcvs, int dx, int dx) {
//             int rw = pcvs.get_crw() * 3;
//             int rh = pcvs.get_crh() * 3;
//             int rx = (int)Math.round(dx - ((double)rw / 2));
//             int ry = (int)Math.round(dx - ((double)rh / 2));
